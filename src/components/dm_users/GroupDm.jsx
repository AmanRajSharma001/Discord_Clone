...
function GroupDm({ groups, setGroups, selectedGroup,users,setUserData,setOpenGroup }) {
        ...
        <div className='group-dm'>
            ...
            <div className='group-dm-data'>
                ...
                <div className="group-main-right">
                    <ActiveGroupUsers groups = {groups} setGroups = {setGroups} selectedGroup = {selectedGroup} users = {users} setUserData = {setUserData} />
                </div>
            </div>
        </div>
  )
