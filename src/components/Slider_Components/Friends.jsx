...
function Friends({users,setUserData,getRandomActivity,user,setUser,sliderComponent,setSliderComponent,selectedFriends, setSelectedFriends,groups,setGroups,selectedGroup,setSelectedGroup}) {
    ...
    const handleCreateMessage = () => {
        const finalGroupName = groupName.trim() || selectedFriends.map(id =>users.find(u => u.id === id)?.name).join(", ");        
        const newGroup = {
            id: Date.now(),
            name: finalGroupName,
                        ...
                        <div className='dm-heading'>
                            ...
                            <div className='search-data'>
                                {selectedFriends.map((x)=>{
                                    const friend = users.find(u => u.id == x);
                                    return (
